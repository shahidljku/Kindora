...
try {
    $south_america_destinations_result = $conn->query("
        ...
        WHERE d.type = 'south_america' AND d.name != 'My Trip Planner'
        GROUP BY d.destination_id
        ORDER BY d.name
    ");
    $south_america_destinations = $south_america_destinations_result ? $south_america_destinations_result->fetch_all(MYSQLI_ASSOC) : [];
} catch (Exception $e) {
    error_log("Error fetching South America destinations: " . $e->getMessage());
...
<head>
    ...
    <title>South America Destinations - Kindora</title>
    <link href="south_america.css" rel="stylesheet">
    <link rel="icon" type="image/png" href="kindora-logo.ico">
    <link href="common_nav_footer.css" rel="stylesheet">
    <meta name="description" content="Explore South America with Kindora - From ancient civilizations to breathtaking landscapes">
</head>
<body>
    <!-- Background Video -->
    <div class="video-container">
        <video autoplay muted loop id="bg-video" preload="metadata">
            <source src="continents_videos/south_america_intro.webm" type="video/webm">
            <source src="continents_videos/south_america_intro.mp4" type="video/mp4">
        </video>
        <div class="video-overlay">
            <h1>Discover South America</h1>
            <p>Ancient mysteries meet natural wonders</p>
        </div>
    </div>
            ...
            <div class="inspire-wrapper">
                ...
                <div class="scroll-container1" id="inspireScroll">
                    <a data-href="asia.php"><div class="image-wrapper1">
                        <img src="web_images/banner/asia.jpg" alt="Asia" loading="lazy">
                    ...
                    <a data-href="africa.php"><div class="image-wrapper1">
                        <img src="web_images/banner/africa.jpg" alt="Africa" loading="lazy">
                        <div class="overlay-text">Africa</div>
                    </div></a>
                    <a data-href="north_america.php"><div class="image-wrapper1">
                        <img src="web_images/banner/north_america.jpg" alt="North America" loading="lazy">
                        <div class="overlay-text">North America</div>
                    </div></a>
                    <a data-href="south_america.php" class="active"><div class="image-wrapper1">
                    ...
                    <a data-href="australia.php"><div class="image-wrapper1">
                        <img src="web_images/banner/australia.jpg" alt="Australia" loading="lazy">
    ...
    <main>
        ...
        <div class="stats-section">
            <div class="container">
                <div class="stats-grid">
                    <div class="stat-item">
                        <span class="stat-number"><?= count($south_america_destinations) ?></span>
                        <span class="stat-label">Destinations</span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-number"><?= array_sum(array_column($south_america_destinations, 'booking_count')) ?></span>
                        <span class="stat-label">Adventurers</span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-number"><?= count($south_america_destinations) > 0 ? number_format(array_sum(array_column($south_america_destinations, 'avg_rating')) / count($south_america_destinations), 1) : '0' ?></span>
        ...
        <div class="container">
            <div class="card-grid">
                <?php if (!empty($south_america_destinations)): ?>
                    <?php foreach ($south_america_destinations as $destination): ?>
                        <div class="video-card destination-card" 
                            ...
                            <div class="card-image">
                                <img src="<?= str_replace('\\\\', '/', htmlspecialchars($destination['image_url'])) ?>" 
                                     ...
                                     loading="lazy"
                                     onerror="this.src='continents/images/south_america_images/default.jpg'">
                                     
                                <?php if ($destination['booking_count'] > 6): ?>
                                    <div class="popular-badge">🏔️ Adventure Hotspot</div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="card-overlay">
                                ...
                                <?php if ($destination['booking_count'] > 0): ?>
                                    <div class="booking-info">
                                        <span class="booking-count">🌎 <?= $destination['booking_count'] ?> explorers</span>
                                    </div>
                                <?php endif; ?>
                ...
                <?php else: ?>
                    <div class="no-destinations">
                        <h3>South American Adventures Coming Soon</h3>
                        <p>We're preparing incredible journeys through the heart of South America.</p>
                    </div>
                <?php endif; ?>
                ...
                <div class="video-card trip-planner-card" onclick="showTripPlanner()">
                    <div class="card-image">
                        <img src="continents/images/south_america_images/trip_planner.avif" alt="My Trip Planner" loading="lazy">
                    </div>
                    <div class="card-overlay">
                        <h3>My Andes Adventure Planner</h3>
                        <p>Plan your epic South American journey through ancient lands and natural wonders.</p>
                        <div class="card-actions">
                            <button class="view-btn">📋 Plan Journey</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
                ...
                .then(data => {
                    document.getElementById('modalContent').innerHTML = `
                        ...
                        <div class="modal-actions" style="margin-top: 20px;">
                            <a href="booking.php?destination=${data.destination_id}" class="book-btn">Start Adventure</a>
                        </div>
                    `;
        ...
        function showTripPlanner() {
            <?php if (isset($_SESSION['user_id'])): ?>
                window.location.href = 'trip_planner.php?continent=south_america';
            <?php else: ?>
