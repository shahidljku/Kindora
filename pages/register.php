...
<html lang="en">
  <head>
    ...
    <title>Kindora – Register</title>
    <link href="/Kindora/assets/css/common_nav_footer.css" rel="stylesheet" />
        ...
        <div class="inspire-wrapper">
          ...
          <div class="scroll-container1" id="inspireScroll">
            ...
            <a data-href="north_america.php">
              <div class="image-wrapper1">
                <img src="web images/banner/north america.jpg" alt="North America" />
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    require_once '../config.php'; // PDO-based config
    ...
    // Client-side check (also do server-side)
    ...
    $existingUser = KindoraDatabase::fetchOne(
    ...
    if ($existingUser) {
        ...
        $success = KindoraDatabase::execute(
            "INSERT INTO users (email, password, full_name, role, created_at) VALUES (?, ?, ?, 'user', NOW())",
            array($email, $hashed_pass, $fullName)
        );
...
?>
    ...
    <script src="/Kindora/assets/js/common_nav_footer.js"></script>
