...
$path = array(
    ...
    // BANNER PATHS
    // ============================================
    'banner_asia' => $basePath . 'web images/banner/asia.jpg',
    'banner_europe' => $basePath . 'web images/banner/europe.jpeg',
    'banner_africa' => $basePath . 'web images/banner/africa.jpg',
    'banner_north_america' => $basePath . 'web images/banner/north america.jpg',
    'banner_south_america' => $basePath . '7wonders/7_wonders/Machu Picchu.jpeg',
    'banner_australia' => $basePath . 'web images/banner/australia.jpg',
 ...
 * Usage: echo getImagePath('places', 'Eiffel Tower.jpg');
 * Usage: echo getImagePath('7wonders', 'Taj-Mahal.jpg');
 */
